...
use crate::routes::{
    create_article, delete_article, follow_user, get_admin_dashboard, get_article,
    get_article_page, get_articles_list_page, get_current_user, get_edit_article_page,
    get_editor_page, get_index, get_login_page, get_profile, get_profile_page, get_register_page,
    handle_404_simple, health_check, list_articles, login_user, register_user, unfollow_user,
